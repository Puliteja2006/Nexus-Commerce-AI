...
import com.nexuscommerce.repository.*;
...
public class AiRecommendationServiceImpl implements AiRecommendationService {
    ...
    public AiChatResponse chatWithAiAssistant(String userEmail, AiChatRequest request) {
        ...
        if (msg.contains("laptop") || msg.contains("macbook") || msg.contains("workstation") || msg.contains("computer")) {
            ...
            matchedProducts = productRepository.findAll().stream()
                    ...
                    .limit(3)
                    .collect(Collectors.toList());
            reply = "Here are top-rated audiophile noise-canceling headphones and acoustic equipment available on NexusCommerce:";
            ...
            matchedProducts = productRepository.findByFeaturedTrueAndActiveTrue().stream()
                    .limit(3)
                    .collect(Collectors.toList());
            reply = "Hello! I am Nexus AI, your personal commerce assistant. Based on your prompt, here are our overall top recommended products:";
        }
    ...
    private ProductDto mapToDto(Product product) {
        return ProductDto.builder()
                ...
                .sellerStoreName(product.getSellerStore() != null ? product.getSellerStore().getStoreName() : "Nexus Official Store")
