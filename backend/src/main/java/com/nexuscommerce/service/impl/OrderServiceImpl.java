...
import com.nexuscommerce.dto.order.OrderItemDto;
...
import com.nexuscommerce.service.CouponService;
import com.nexuscommerce.service.InventoryService;
import com.nexuscommerce.service.OrderService;
    ...
    private OrderDto mapToOrderDto(Order order) {
        List<OrderItemDto> itemDtos = order.getItems().stream().map(item -> {
            ...
            return OrderItemDto.builder()
                    ...
                    .sellerStoreName(item.getSellerStore() != null ? item.getSellerStore().getStoreName() : "Nexus Official Store")
                    .build();
        }).collect(Collectors.toList());
