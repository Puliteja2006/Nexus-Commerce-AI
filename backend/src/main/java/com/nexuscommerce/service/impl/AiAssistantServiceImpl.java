...
import com.nexuscommerce.service.AiAssistantService;
...
public class AiAssistantServiceImpl implements AiAssistantService {
    ...
    public AiAssistantResponse processAssistantChat(AiAssistantRequest request) {
        ...
        if (lowerMsg.contains("payment") || lowerMsg.contains("card") || lowerMsg.contains("paypal") || lowerMsg.contains("cod") || lowerMsg.contains("stripe")) {
            ...
            .reply("NexusCommerce AI supports Credit/Debit Cards (Visa, MasterCard, Amex via Stripe), PayPal One-Touch, and Cash on Delivery (COD) for eligible regional zip codes. All online transactions are 256-bit SSL encrypted.")
            .recommendedProducts(List.of())
