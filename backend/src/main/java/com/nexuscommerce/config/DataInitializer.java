...
import com.nexuscommerce.entity.*;
import com.nexuscommerce.repository.CategoryRepository;
import com.nexuscommerce.repository.CouponRepository;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        log.info("Initializing NexusCommerce catalog data, categories & demo users...");
        seedDemoUsersIfEmpty();
        seedDefaultCategoriesIfEmpty();
        seedShoeCatalogIfEmpty();
        seedCouponsIfEmpty();
        log.info("NexusCommerce data initialization complete!");
    }

    private void seedDemoUsersIfEmpty() {
        if (!userRepository.existsByEmail("customer@nexuscommerce.com")) {
            ...
            log.info("Seeded demo customer user: customer@nexuscommerce.com");
        }

        if (!userRepository.existsByEmail("seller@nexuscommerce.com")) {
            User seller = User.builder()
                    .email("seller@nexuscommerce.com")
            ...
            log.info("Seeded demo seller user: seller@nexuscommerce.com");
        }
        ...
        if (!userRepository.existsByEmail("admin@nexuscommerce.com")) {
            ...
            log.info("Seeded demo admin user: admin@nexuscommerce.com");
        }
    }
