...
public class HealthController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getHealthStatus() {
        ...
        healthInfo.put("service", "NexusCommerce AI Backend API");
        ...
        return ResponseEntity.ok(ApiResponse.success("NexusCommerce API service is healthy and operational", healthInfo));
    }
}
