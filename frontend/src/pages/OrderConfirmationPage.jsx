    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="glass-panel p-8 sm:p-12 rounded-3xl text-center space-y-4 border border-emerald-500/40 relative overflow-hidden">
        ...
        <p className="text-xs sm:text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
          Thank you for shopping with NexusCommerce AI. Order reference <strong className="text-nexus-400 font-mono">{order.orderNumber}</strong> has been logged in our processing queue.
        </p>
