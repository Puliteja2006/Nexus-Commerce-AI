    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Sign in to access your NexusCommerce account & AI tools</p>
        </div>
        ...
        <div className="glass-panel p-4 rounded-2xl border border-slate-800 space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              type="button"
              onClick={() => fillDemoAccount('customer@nexuscommerce.com', 'Customer@12345')}
            ...
            <button
              type="button"
              onClick={() => fillDemoAccount('seller@nexuscommerce.com', 'Seller@12345')}
              className="py-2 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-xl text-[11px] font-bold text-slate-300 hover:text-white transition flex flex-col items-center gap-1"
            >
            ...
            <button
              type="button"
              onClick={() => fillDemoAccount('admin@nexuscommerce.com', 'Admin@12345')}
              className="py-2 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-xl text-[11px] font-bold text-slate-300 hover:text-white transition flex flex-col items-center gap-1"
            >
        ...
        <form onSubmit={handleSubmit} className="glass-card p-6 rounded-3xl border border-slate-800 space-y-4 shadow-2xl">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="customer@nexuscommerce.com"
          ...
          >
            {submitting ? (
              ...
              <>
                <LogIn className="w-4 h-4" /> Sign In to NexusCommerce
              </>
            )}
          </button>
        </form>
