  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: 'ai',
      text: 'Hello! I am Nexus AI, your autonomous smart commerce advisor. Tell me what you are looking for (e.g. laptops, audio gear, running shoes), or click a prompt below!',
      products: [],
      timestamp: new Date(),
    }
  ]);
        ...
        <div className="pt-3 border-t border-slate-800 space-y-3">
          ...
          >
            <input
              ...
              placeholder="Ask Nexus AI to recommend laptops, smartphones, audio gear, budget deals..."
