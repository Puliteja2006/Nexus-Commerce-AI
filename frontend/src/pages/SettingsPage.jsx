...
export default function SettingsPage() {
  ...
  const [email, setEmail] = useState(user?.email || 'customer@nexuscommerce.com');
  ...
  const handleDeleteAccount = () => {
    if (window.confirm('WARNING: Are you sure you want to delete your NexusCommerce account? This action is permanent.')) {
