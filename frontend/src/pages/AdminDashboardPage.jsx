...
export default function AdminDashboardPage() {
  ...
  const [tickets, setTickets] = useState([
    { id: 'TCK-9812', requester: 'customer@nexuscommerce.com', subject: 'Disputed delivery charge on Express tier', status: 'OPEN', priority: 'HIGH', date: '2026-07-29' },
    { id: 'TCK-4321', requester: 'seller@nexuscommerce.com', subject: 'KYC Verification documentation clarification', status: 'RESOLVED', priority: 'MEDIUM', date: '2026-07-25' },
                  ...
                  <div className="h-28 w-full flex items-end justify-between border-b border-slate-800 pb-1 pt-4">
                    {[34, 52, 68, 79, 95, 120, 145].map((val, idx) => (
                      <div key={idx} className="flex-1 flex flex-col items-center">
                        ...
                        <span className="text-[9px] text-slate-500 mt-1 font-mono">Wk {idx+1}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="p-5 bg-slate-900 border border-slate-800 rounded-2xl space-y-3">
              ...
              <div className="space-y-2">
                <div className="p-3 bg-slate-950/50 rounded-xl flex justify-between items-center">
                  <div>
                    <span className="text-white font-semibold font-mono block">JWT-Session: admin@nexuscommerce.com</span>
