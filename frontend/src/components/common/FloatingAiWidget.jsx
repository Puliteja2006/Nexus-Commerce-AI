  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: 'ai',
      text: 'Hello! I am Nexus AI, your personal shopping assistant. How can I help you today?',
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        ...
        >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-xs font-extrabold text-white flex items-center gap-1.5">
                  Nexus AI Shopping Assistant <Sparkles className="w-3 h-3 text-amber-400" />
                </h3>
            ...
            {loading && (
              <div className="flex items-start gap-2 text-slate-400 text-xs">
                <div className="bg-slate-900 border border-slate-800 p-3 rounded-2xl rounded-bl-none flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] ml-1 font-mono text-slate-500">Nexus AI processing...</span>
                </div>
              </div>
            )}
          ...
          >
            <input
              ...
              placeholder="Ask Nexus AI (e.g. gaming laptops, return policy)..."
      ...
      {!isOpen && (
        ...
        >
          ...
          <span className="text-xs font-bold tracking-wide">Ask Nexus AI</span>
        </button>
      )}
